...
<body>
    ...
    <header>
            <div class="container">
                ...
                <nav>
                    ...
                    <a href="../HTML/signup.html" class="icon" >
                        <i class="fa-solid fa-right-to-bracket"></i>
                    </a>
                    <button class="icon" id="btn"><i class="fa-solid fa-user-plus"></i></button>
    ...
    <div class="partie">
        <div class="container">
            <div class="partie_content">
                <div class="pages">
                    <iframe src="profil.php" name="profil" ></iframe>
                </div>
                <ul class="table">
                    ...
                    <li><a href="http://www.jeux.com/" target="profil">JEUX</a></li>
                </ul>
            </div>
        </div>
    </div>
