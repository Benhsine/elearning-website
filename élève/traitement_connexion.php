...
try {
  ...
  $requete = "SELECT id, nom, prenom, email, password, cin_pere FROM etudient WHERE email = :email";
  ...
  if ($utilisateur && verifyPassword($password, $utilisateur['password'])){
    ...
    $_SESSION['cin_pere'] = $utilisateur['cin_pere'];
